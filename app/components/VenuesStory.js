  ...
  return (
    ...
    <div className={clsx('max-w-7xl', 'mx-auto', 'px-6', 'min-[1050px]:px-10', 'relative', 'z-20', 'mt-4', 'min-[1050px]:-mt-87')}>
        ...
        <div id="locations" className={clsx('mb-8', 'min-[1050px]:mb-14', 'scroll-mt-24')}>
          ...
          <div className={clsx('flex', 'flex-col', 'md:flex-row', 'md:items-center', 'justify-between', 'gap-3', 'mb-12', 'lg:mb-8')} data-aos="fade-up" data-aos-duration="1000">
            <div className={clsx('flex', 'items-center', 'gap-4', 'flex-1')}>
              <h2
                className={clsx('font-playfair', 'text-lg', 'sm:text-xl', 'lg:text-2xl', 'font-bold', 'uppercase', 'tracking-tight', 'text-[#1A1A1A]', 'shrink-0', 'underline', 'underline-offset-4')}
              >
