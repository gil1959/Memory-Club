        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-10 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-3 ml-2">
              <a href="https://instagram.com/yourmemoryclub" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-text-dark/10 flex items-center justify-center hover:bg-text-dark/20 transition-colors" aria-label="Instagram">
